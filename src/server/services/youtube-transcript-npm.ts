/**
 * YouTube transcript fetcher via innertube ANDROID client.
 *
 * Works locally and on some cloud IPs. For videos where this fails,
 * users can manually upload transcripts via the UI.
 */
...
/**
 * Fetch YouTube transcript via innertube ANDROID client.
 */
export async function fetchYouTubeTranscriptViaNpm(
  ...
  console.warn(`[YouTube] Transcript fetch failed for ${videoId}`);
  return null;
}
